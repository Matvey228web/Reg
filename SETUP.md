...
5. **Создайте структуру таблицы**: вверху редактора, рядом с кнопкой «Выполнить» (Run), в списке функций должна быть выбрана `setupSheets` — нажмите **Выполнить**.
...
## 8. Локальная проверка бэкенда (для разработки)
