...
// переехало на обычную кнопку: жест ничем не подписан, на складе его не
// находили, и снаружи система выглядела как «умеет только отключать».
// Модуль оставлен рабочим и проверенным — под списки, где действие
// второстепенное и его уместно спрятать.
//
