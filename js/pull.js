...
//
// В мини-приложении Telegram вертикальный свайп вниз ЗАКРЫВАЕТ приложение.
// Поэтому жест ставится только если клиент умеет отключить свой свайп
// (Bot API 7.7, TG.lockVerticalSwipes); где не умеет — жеста нет вовсе,
// остаётся кнопка «Обновить». Вне Telegram тянуть безопасно.
